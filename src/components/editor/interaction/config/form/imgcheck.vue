<!--单选-->
<template>
  <div class="imgcheck-form-element">
      <!--标题-->
      ...
      <div class="input-text">
        <span>最少选</span><input type="text" v-model="itemData.module_min" @change="onInputChange"/></span><span>项</span>
        <span>最多选</span><input type="text" v-model="itemData.module_max" @change="onInputChange"/></span><span>项</span>
      </div>
