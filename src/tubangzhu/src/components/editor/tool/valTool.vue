<template>
	<div class="val-tool">
        <span class="tool-text yes btn" @click="yes"></span>
        <span class="tool-text no btn" @click="no"></span>
    </div>
</template>
<script>
